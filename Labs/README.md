...
## FYI: many of these labs are being moved to [Microsoft Learn](docs.microsoft.com/learn). Learn gives you the ability to run all of these (and more!) great labs for free - without using your Azure credits. Check it out at <docs.microsoft.com/learn>!
